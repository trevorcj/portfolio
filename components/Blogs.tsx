      ...
      {blogs.map((blog) => (
        <li key={blog.id}>
          <Link
            ...
            className="no-link-style flex flex-col gap-1 border-b border-[#2c2b2b] py-3 p-0 text-sm transition-all duration-500 ease-in-out hover:pl-2 first:pt-0 last:border-b-0 sm:flex-row sm:justify-between sm:gap-4"
          >
